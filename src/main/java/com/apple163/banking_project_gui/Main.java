...
public class Main extends Application
{
    ...
    public void start(Stage primaryStage)
    {
        ...
        Image fd = new Image("\\resources\\Fd.png");
        Image rd = new Image("\\resources\\Rd.png");
        Image currency = new Image("\\resources\\Cur.png");
        Image loan = new Image("\\resources\\Loan.png");
        Image insurance = new Image("\\resources\\Insurance.png");
        Image shares = new Image("\\resources\\Shares.png");
        Image fd_bl = new Image("\\resources\\Fd_bl.png");
        Image rd_bl = new Image("\\resources\\Rd_bl.png");
        Image currency_bl = new Image("\\resources\\Cur_bl.png");
        Image loan_bl = new Image("\\resources\\Loan_bl.png");
        Image insurance_bl = new Image("\\resources\\Insurance_bl.png");
        Image shares_bl = new Image("\\resources\\Shares_bl.png");
